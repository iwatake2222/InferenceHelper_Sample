...
#define MODEL_NAME  "person-detection-0202/model_float32.onnx"
//#define MODEL_NAME  "person-detection-0202/model_float32.xml"   /* for OpenVINO */
#define INPUT_NAME  "image"
#define INPUT_DIMS  { 1, 3, 512, 512 }
...
#if 1
#define MODEL_NAME  "person-detection-0202/model_float32.tflite"
#define INPUT_NAME  "serving_default_image:0"
#define INPUT_DIMS  { 1, 512, 512, 3 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
...
#else
#define MODEL_NAME  "person-detection-0202/model_full_integer_quant.tflite"
#define INPUT_NAME  "serving_default_image:0"
#define INPUT_DIMS  { 1, 512, 512, 3 }
...
#define MODEL_NAME  "person-detection-0202/model_full_integer_quant_edgetpu.tflite"
#define INPUT_NAME  "serving_default_image:0"
#define INPUT_DIMS  { 1, 512, 512, 3 }
#define TENSORTYPE  TensorInfo::kTensorTypeUint8
#define IS_NCHW     false
...
#define MODEL_NAME  "person-detection-0202/model_float32.ncnn.param"
#define INPUT_NAME  "image"
#define INPUT_DIMS  { 1, 3, 512, 512 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "person-detection-0202/model_float32.mnn"
#define INPUT_NAME  "image"
#define INPUT_DIMS  { 1, 3, 512, 512 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "person-detection-0202/model_float32.dlc"
#define INPUT_NAME  "image"
#define INPUT_DIMS  { 1, 3, 512, 512 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "person-detection-0202/model_float32.nnp"
#define INPUT_NAME  "image"
#define INPUT_DIMS  { 1, 3, 512, 512 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "person-detection-0202/model_float32.all.ort"
#define INPUT_NAME  "image"
#define INPUT_DIMS  { 1, 3, 512, 512 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "person-detection-0202/saved_model"
#define INPUT_NAME  "serving_default_image:0"
#define INPUT_DIMS  { 1, 512, 512, 3 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     false
...
static const std::vector<std::string> kLabelList{ "Person" };
static constexpr int32_t kNumClass = 1;
...
int32_t DetectionEngine::Process(const cv::Mat& original_mat, Result& result)
{
    ...
    static const size_t kNumPrior = output_bbox_list.size() / 4;
