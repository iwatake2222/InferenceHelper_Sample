...
int32_t ImageProcessor::Process(cv::Mat& mat, ImageProcessor::Result& result)
{
    ...
    DrawText(mat, text, cv::Point(0, 20), 0.5, 2, CreateCvColor(0, 0, 0), CreateCvColor(180, 180, 180), true);

    DrawFps(mat, cls_result.time_inference, cv::Point(0, 0), 0.5, 2, CreateCvColor(0, 0, 0), CreateCvColor(180, 180, 180), true);
