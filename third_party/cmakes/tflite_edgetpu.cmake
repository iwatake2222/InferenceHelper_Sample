...
if(MSVC_VERSION)
	...
	# if(${BUILD_SYSTEM} STREQUAL "x64_linux")
	# 	set(TFLITE_EDGETPU_LIB ${CMAKE_CURRENT_LIST_DIR}/../edgetpu/libedgetpu/direct/k8/libedgetpu.so.1.0)
	# elseif(${BUILD_SYSTEM} STREQUAL "armv7")
	# 	set(TFLITE_EDGETPU_LIB ${CMAKE_CURRENT_LIST_DIR}/../edgetpu/libedgetpu/direct/armv7a/libedgetpu.so.1.0)
	# elseif(${BUILD_SYSTEM} STREQUAL "aarch64")
	# 	set(TFLITE_EDGETPU_LIB ${CMAKE_CURRENT_LIST_DIR}/../edgetpu/libedgetpu/direct/aarch64/libedgetpu.so.1.0)
	# else()	
	# 	message(FATAL_ERROR "[tflite_edgetpu] unsupported platform")
	# endif()
