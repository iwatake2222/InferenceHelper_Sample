...
#define MODEL_NAME  "yolox_nano_480x640/model_float32.onnx"
...
#if 1
#define MODEL_NAME  "yolox_nano_480x640/model_float32.tflite"
#define INPUT_NAME  "images"
...
#else
#define MODEL_NAME  "yolox_nano_480x640/model_full_integer_quant.tflite"
#define INPUT_NAME  "serving_default_images:0"
#define INPUT_DIMS  { 1, 480, 640, 3 }
...
#define MODEL_NAME  "yolox_nano_480x640/model_full_integer_quant_edgetpu.tflite"
#define INPUT_NAME  "serving_default_images:0"
#define INPUT_DIMS  { 1, 480, 640, 3 }
#define TENSORTYPE  TensorInfo::kTensorTypeUint8
#define IS_NCHW     false
...
#define MODEL_NAME  "yolox_nano_480x640/model_float32.ncnn.param"
#define INPUT_NAME  "images"
#define INPUT_DIMS  { 1, 3, 640, 640 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
#define IS_RGB      true
#define OUTPUT_NAME_0 "output"
#elif defined(INFERENCE_HELPER_ENABLE_MNN)
#define MODEL_NAME  "yolox_nano_480x640/model_float32.mnn"
#define INPUT_NAME  "images"
#define INPUT_DIMS  { 1, 3, 480, 640 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "yolox_nano_480x640/model_float32.dlc"
#define INPUT_NAME  "images"
#define INPUT_DIMS  { 1, 3, 480, 640 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "yolox_nano_480x640/model_float32.nnp"
#define INPUT_NAME  "images"
#define INPUT_DIMS  { 1, 3, 480, 640 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "yolox_nano_480x640/model_float32.all.ort"
#define INPUT_NAME  "images"
#define INPUT_DIMS  { 1, 3, 480, 640 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     true
...
#define MODEL_NAME  "yolox_nano_480x640/saved_model"
#define INPUT_NAME  "serving_default_images:0"
#define INPUT_DIMS  { 1, 480, 640, 3 }
#define TENSORTYPE  TensorInfo::kTensorTypeFp32
#define IS_NCHW     false
...
#define LABEL_NAME   "yolox_nano_480x640/label_coco_80.txt"
...
#if defined(INFERENCE_HELPER_ENABLE_NCNN)
    /* Don't normalize */
